...
class PolandNews extends React.Component {
        ...
        <div className="container">
          ...
          <div className="columns is-multiline">
            <div className="column is-half-tablet is-half-desktop">
              ...
              <h2 className="subtitle is-6">Filtrowane Wiadomości z najpopularniejszych źródeł na całym świecie</h2>
            </div>
