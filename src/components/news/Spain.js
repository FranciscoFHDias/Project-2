...
class SpainNews extends React.Component {
        ...
        <div className="container">
          ...
          <div className="columns is-multiline">
            <div className="column is-half-tablet is-half-desktop">
              <h1 className="title is-1">Noticias españolas</h1>
              <h2 className="subtitle is-6">Noticias de las principales fuentes de noticias del mundo filtradas cronológicamente</h2>
            </div>
